...
type Editor struct {
	...
	collisionTestBSP      *pb.LevelData         // cached BSP tree with flat structure
...
func (e *Editor) lineTraceBSP(fromX, fromY, toX, toY float32) (hit bool, hitX, hitY float32) {
	...
	// Use the flat BSP tree line trace
	return bsp.LineTraceBSPNode(e.collisionTestBSP.Nodes, e.collisionTestBSP.RootIndex, from, to, 0.0, 1.0)
}
