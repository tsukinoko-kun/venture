...
// LoadAssets scans the assets directory and builds the folder/file structure
...
// layoutFolderList renders the folder navigation panel
...
// layoutAssetList renders the asset grid for the selected folder
